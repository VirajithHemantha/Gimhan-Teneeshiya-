...
export const Footer: React.FC = () => {
  return (
    <footer aria-label="Footer" className="relative py-20 sm:py-28 px-6 text-center overflow-hidden bg-[#0C0B09]">
      ...
      <div className="relative mx-auto max-w-lg">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl mb-4 text-white" style={{ textShadow: "rgba(255, 255, 255, 0.1) 0px 0px 48px" }}>
        ...
        <p className="font-display mt-6 text-base sm:text-lg font-light italic" style={{ color: "rgba(232, 197, 71, 0.62)" }}>
